...
bool &Global::printdat()
{
    static bool printdat_ = false;
    return printdat_;
}
Real &Global::printScale()
{
...
void Global::warnDeprecated(const std::string &message)
{
