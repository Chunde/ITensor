...
namespace itensor
{
    ...
    template <typename T>
    bool constexpr isReal(Scalar<T> const &t) { return std::is_same<T, Real>::value; }

    template <typename T>
    bool constexpr isCplx(Scalar<T> const &t) { return std::is_same<T, Cplx>::value; }
    ...
    template <typename T>
    bool constexpr doTask(CheckComplex, Scalar<T> const &d) { return isCplx(d); }
    ...
    auto constexpr inline doTask(StorageType const &S, ScalarReal const &d) -> StorageType::Type { return StorageType::ScalarReal; }

    auto constexpr inline doTask(StorageType const &S, ScalarCplx const &d) -> StorageType::Type { return StorageType::ScalarCplx; }
