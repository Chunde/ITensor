...
template <typename Set1, typename Set2Iter, typename RType, typename Map>
void permute_map(const Set1& s1, const Set2Iter& s2begin, const Set2Iter& s2end,
                 RType& r, Map&& m)
{
...
template <typename Set1, typename Set2, typename RType, typename Map>
void permute_map(const Set1& s1, const Set2& s2, RType& r, Map&& m)
{
...
inline long& seed_quickran(int newseed)
{
...
const_correct_ptr<Container> binaryFind(Container& c, const T& val,
                                        Compare less)
{
