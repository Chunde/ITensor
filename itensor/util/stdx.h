...
namespace stdx
{
    ...
    struct is_vector_impl<std::vector<Ts...>> : std::true_type
    {
    };
    template <typename C>
    ...
    template <typename... Ts>
    struct is_initializer_list_impl<std::initializer_list<Ts...>> : std::true_type
    {
    };
    template <typename C>
    ...
    auto constexpr make_array(Ts &&...t)
