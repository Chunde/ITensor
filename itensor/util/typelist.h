...
namespace itensor
{
    ...
    struct TypeList
    {
        size_t static constexpr size() { return 0ul; }
    ...
    struct TypeList<T, Ts...> : TypeList<Ts...>
    {
        ...
        size_t static constexpr size() { return 1ul + Next::size(); }
    ...
    using getType = typename detail::GetType < TList,
          n, n<TList::size()>::Result;
