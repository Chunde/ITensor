...
namespace itensor
{
    ...
    public:
        ...
        explicit ITensor(Index const &i1,
                         Inds const &...inds);
        ...
        template <typename... Inds>
        explicit ITensor(QN q, Index const &i1,
                         Inds const &...inds);
        ...
        explicit ITensor(IndexSet iset,
                         StorageType &&store,
    ...
    template <typename Container,
              class = stdx::enable_if_t<stdx::containerOf<Real, Container>::value || stdx::containerOf<Cplx, Container>::value>>
    ITensor
