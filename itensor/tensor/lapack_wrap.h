...
inline LAPACK_REAL &realRef(LAPACK_COMPLEX &z)
{
    auto *p = reinterpret_cast<double *>(&z);
    return p[0];
}

inline LAPACK_REAL &imagRef(LAPACK_COMPLEX &z)
{
    auto *p = reinterpret_cast<double *>(&z);
    return p[1];
}
...
inline LAPACK_REAL &realRef(LAPACK_COMPLEX &z) { return z.r; }

inline LAPACK_REAL &imagRef(LAPACK_COMPLEX &z) { return z.i; }
}  // namespace itensor
...
inline LAPACK_REAL &realRef(LAPACK_COMPLEX &z) { return z.real; }

inline LAPACK_REAL &imagRef(LAPACK_COMPLEX &z) { return z.imag; }
}  // namespace itensor
...
#else
void F77NAME(daxpy)(LAPACK_INT *n, LAPACK_REAL *alpha, LAPACK_REAL *X,
                    LAPACK_INT *incx, LAPACK_REAL *Y, LAPACK_INT *incy);
#endif

// ddot declaration
#ifdef ITENSOR_USE_CBLAS
LAPACK_REAL
cblas_ddot(const LAPACK_INT N, const LAPACK_REAL *X, const LAPACK_INT incx,
           const LAPACK_REAL *Y, const LAPACK_INT incy);
#else
LAPACK_REAL F77NAME(ddot)(LAPACK_INT *N, LAPACK_REAL *X, LAPACK_INT *incx,
...
#ifdef ITENSOR_USE_CBLAS
LAPACK_REAL
cblas_zdotc_sub(const LAPACK_INT N, const void *X, const LAPACK_INT incx,
                const void *Y, const LAPACK_INT incy, void *res);
#else
LAPACK_COMPLEX F77NAME(zdotc)(LAPACK_INT *N, LAPACK_COMPLEX *X,
                              LAPACK_INT *incx, LAPACK_COMPLEX *Y,
                              LAPACK_INT *incy);
#endif
...
void cblas_dgemm(const enum CBLAS_ORDER __Order,
                 ...
                 const double *__A, const int __lda, const double *__B,
                 const int __ldb, const double __beta, double *__C,
                 const int __ldc);
#else
...
void cblas_zgemm(const enum CBLAS_ORDER __Order,
                 const enum CBLAS_TRANSPOSE __TransA,
                 const enum CBLAS_TRANSPOSE __TransB, const int __M,
                 const int __N, const int __K, const void *__alpha,
                 const void *__A, const int __lda, const void *__B,
                 const int __ldb, const void *__beta, void *__C,
                 const int __ldc);
#else
void F77NAME(zgemm)(char *transa, char *transb, LAPACK_INT *m, LAPACK_INT *n,
                    LAPACK_INT *k, LAPACK_COMPLEX *alpha, LAPACK_COMPLEX *A,
                    LAPACK_INT *LDA, LAPACK_COMPLEX *B, LAPACK_INT *LDB,
                    LAPACK_COMPLEX *beta, LAPACK_COMPLEX *C, LAPACK_INT *LDC);
#endif
...
void cblas_dgemv(const enum CBLAS_ORDER Order,
                 const enum CBLAS_TRANSPOSE TransA, const LAPACK_INT M,
                 const LAPACK_INT N, const LAPACK_REAL alpha,
                 const LAPACK_REAL *A, const LAPACK_INT lda,
                 const LAPACK_REAL *X, const LAPACK_INT incX,
                 const LAPACK_REAL beta, LAPACK_REAL *Y, const LAPACK_INT incY);
#else
void F77NAME(dgemv)(char *transa, LAPACK_INT *M, LAPACK_INT *N,
                    LAPACK_REAL *alpha, LAPACK_REAL *A, LAPACK_INT *LDA,
                    LAPACK_REAL *X, LAPACK_INT *incx, LAPACK_REAL *beta,
                    LAPACK_REAL *Y, LAPACK_INT *incy);
#endif
...
void cblas_zgemv(const CBLAS_ORDER Order, const CBLAS_TRANSPOSE trans,
                 const LAPACK_INT m, const LAPACK_INT n, const void *alpha,
                 const void *a, const LAPACK_INT lda, const void *x,
                 const LAPACK_INT incx, const void *beta, void *y,
                 const LAPACK_INT incy);
#else
void F77NAME(zgemv)(char *transa, LAPACK_INT *M, LAPACK_INT *N,
                    LAPACK_COMPLEX *alpha, LAPACK_COMPLEX *A, LAPACK_INT *LDA,
                    LAPACK_COMPLEX *X, LAPACK_INT *incx, LAPACK_COMPLEX *beta,
...
#else
void F77NAME(dsyev)(const char *jobz, const char *uplo, const LAPACK_INT *n,
                    double *a, const LAPACK_INT *lda, double *w, double *work,
                    const LAPACK_INT *lwork, LAPACK_INT *info);
#endif

#ifdef ITENSOR_USE_CBLAS
void cblas_dscal(const LAPACK_INT N, const LAPACK_REAL alpha, LAPACK_REAL *X,
                 const LAPACK_INT incX);
#else
void F77NAME(dscal)(LAPACK_INT *N, LAPACK_REAL *alpha, LAPACK_REAL *X,
                    LAPACK_INT *incX);
#endif

#ifdef PLATFORM_acml
void F77NAME(dgesdd)(char *jobz, LAPACK_INT *m, LAPACK_INT *n, double *a,
...
#ifdef PLATFORM_acml
void F77NAME(dgesvd)(char *jobz, char *jobv, LAPACK_INT *m, LAPACK_INT *n,
...
#ifdef PLATFORM_acml
void F77NAME(zgesvd)(char *jobz, char *jobv, LAPACK_INT *m, LAPACK_INT *n,
                     LAPACK_COMPLEX *a, LAPACK_INT *lda, LAPACK_REAL *s,
                     LAPACK_COMPLEX *u, LAPACK_INT *ldu, LAPACK_COMPLEX *vt,
                     LAPACK_INT *ldvt, LAPACK_COMPLEX *work, LAPACK_INT *lwork,
                     LAPACK_REAL *rwork, LAPACK_INT *info, int jobz_len);
#else
void F77NAME(zgesvd)(char *jobz, char *jobv, LAPACK_INT *m, LAPACK_INT *n,
                     LAPACK_COMPLEX *a, LAPACK_INT *lda, LAPACK_REAL *s,
                     LAPACK_COMPLEX *u, LAPACK_INT *ldu, LAPACK_COMPLEX *vt,
                     LAPACK_INT *ldvt, LAPACK_COMPLEX *work, LAPACK_INT *lwork,
                     LAPACK_REAL *rwork, LAPACK_INT *info);
#endif

#ifdef PLATFORM_acml
void F77NAME(zgesdd)(char *jobz, int *m, int *n, LAPACK_COMPLEX *a, int *lda,
                     double *s, LAPACK_COMPLEX *u, int *ldu, LAPACK_COMPLEX *vt,
                     int *ldvt, LAPACK_COMPLEX *work, int *lwork, double *rwork,
                     int *iwork, int *info, int jobz_len);
#else
void F77NAME(zgesdd)(char *jobz, LAPACK_INT *m, LAPACK_INT *n,
                     LAPACK_COMPLEX *a, LAPACK_INT *lda, double *s,
                     LAPACK_COMPLEX *u, LAPACK_INT *ldu, LAPACK_COMPLEX *vt,
                     LAPACK_INT *ldvt, LAPACK_COMPLEX *work, LAPACK_INT *lwork,
...
void F77NAME(zgeqrf)(LAPACK_INT *m, LAPACK_INT *n, LAPACK_COMPLEX *a,
                     LAPACK_INT *lda, LAPACK_COMPLEX *tau, LAPACK_COMPLEX *work,
                     LAPACK_INT *lwork, LAPACK_INT *info);

#ifdef PLATFORM_lapacke
void LAPACKE_zungqr(int matrix_layout, LAPACK_INT *m, LAPACK_INT *n,
                    LAPACK_INT *k, LAPACK_COMPLEX *a, LAPACK_INT *lda,
                    LAPACK_COMPLEX *tau, LAPACK_COMPLEX *work,
                    LAPACK_INT *lwork, LAPACK_INT *info);
#else
void F77NAME(zungqr)(LAPACK_INT *m, LAPACK_INT *n, LAPACK_INT *k,
                     LAPACK_COMPLEX *a, LAPACK_INT *lda, LAPACK_COMPLEX *tau,
                     LAPACK_COMPLEX *work, LAPACK_INT *lwork, LAPACK_INT *info);
#endif

void F77NAME(dgesv)(LAPACK_INT *n, LAPACK_INT *nrhs, LAPACK_REAL *a,
                    LAPACK_INT *lda, LAPACK_INT *ipiv, LAPACK_REAL *b,
                    LAPACK_INT *ldb, LAPACK_INT *info);

void F77NAME(zgesv)(LAPACK_INT *n, LAPACK_INT *nrhs, LAPACK_COMPLEX *a,
                    LAPACK_INT *lda, LAPACK_INT *ipiv, LAPACK_COMPLEX *b,
                    LAPACK_INT *ldb, LAPACK_INT *info);

#ifdef PLATFORM_lapacke
double LAPACKE_dlange(int matrix_layout, char norm, lapack_int m, lapack_int n,
                      const double *a, lapack_int lda);
#elif defined PLATFORM_acml
double F77NAME(dlange)(char *norm, LAPACK_INT *m, LAPACK_INT *n, double *a,
                       LAPACK_INT *lda, double *work, LAPACK_INT norm_len);
#else
double F77NAME(dlange)(char *norm, LAPACK_INT *m, LAPACK_INT *n, double *a,
...
#ifdef PLATFORM_lapacke
lapack_real LAPACKE_zlange(int matrix_layout, char norm, lapack_int m,
                           lapack_int n, const lapack_complex_double *a,
                           lapack_int lda);
#elif defined PLATFORM_acml
LAPACK_REAL F77NAME(zlange)(char *norm, LAPACK_INT *m, LAPACK_INT *n,
                            LAPACK_COMPLEX *a, LAPACK_INT *lda, double *work,
                            LAPACK_INT norm_len);
#else
LAPACK_REAL F77NAME(zlange)(char *norm, LAPACK_INT *m, LAPACK_INT *n,
                            LAPACK_COMPLEX *a, LAPACK_INT *lda, double *work);
...
#elif defined PLATFORM_acml
void F77NAME(zheev)(char *jobz, char *uplo, LAPACK_INT *n, LAPACK_COMPLEX *a,
                    LAPACK_INT *lda, double *w, LAPACK_COMPLEX *work,
                    LAPACK_INT *lwork, double *rwork, LAPACK_INT *info,
                    LAPACK_INT jobz_len, LAPACK_INT uplo_len);
#else
void F77NAME(zheev)(char *jobz, char *uplo, LAPACK_INT *n, LAPACK_COMPLEX *a,
                    LAPACK_INT *lda, double *w, LAPACK_COMPLEX *work,
                    LAPACK_INT *lwork, double *rwork, LAPACK_INT *info);
...
#ifdef PLATFORM_acml
void F77NAME(dsygv)(LAPACK_INT *itype, char *jobz, char *uplo, LAPACK_INT *n,
...
void F77NAME(dgeev)(char *jobvl, char *jobvr, LAPACK_INT *n, double *a,
                    ...
                    double *work, LAPACK_INT *lwork, LAPACK_INT *info,
                    LAPACK_INT jobvl_len, LAPACK_INT jobvr_len);
#else
void F77NAME(dgeev)(char *jobvl, char *jobvr, LAPACK_INT *n, double *a,
                    LAPACK_INT *lda, double *wr, double *wi, double *vl,
                    LAPACK_INT *ldvl, double *vr, LAPACK_INT *ldvr,
...
void F77NAME(zgeev)(char *jobvl, char *jobvr, LAPACK_INT *n, LAPACK_COMPLEX *a,
                    ...
                    LAPACK_INT *info, LAPACK_INT jobvl_len,
                    LAPACK_INT jobvr_len);
#else
void F77NAME(zgeev)(char *jobvl, char *jobvr, LAPACK_INT *n, LAPACK_COMPLEX *a,
                    LAPACK_INT *lda, LAPACK_COMPLEX *w, LAPACK_COMPLEX *vl,
                    LAPACK_INT *ldvl, LAPACK_COMPLEX *vr, LAPACK_INT *ldvr,
...
// Y += alpha*X
//
void daxpy_wrapper(LAPACK_INT n,          // number of elements of X,Y
...
//
LAPACK_REAL
dnrm2_wrapper(LAPACK_INT N, const LAPACK_REAL *X, LAPACK_INT incx = 1);

//
// ddot
//
LAPACK_REAL
ddot_wrapper(LAPACK_INT N, const LAPACK_REAL *X, LAPACK_INT incx,
             const LAPACK_REAL *Y, LAPACK_INT incy);

//
// zdotc
//
Cplx zdotc_wrapper(LAPACK_INT N, Cplx const *X, LAPACK_INT incx, Cplx const *Y,
                   LAPACK_INT incy);

//
// dgemm
//
void gemm_wrapper(bool transa, bool transb, LAPACK_INT m, LAPACK_INT n,
                  LAPACK_INT k, LAPACK_REAL alpha, LAPACK_REAL const *A,
                  LAPACK_REAL const *B, LAPACK_REAL beta, LAPACK_REAL *C);

//
// zgemm
//
void gemm_wrapper(bool transa, bool transb, LAPACK_INT m, LAPACK_INT n,
                  LAPACK_INT k, Cplx alpha, Cplx const *A, Cplx const *B,
                  Cplx beta, Cplx *C);

//
// dgemv - matrix*vector multiply
//
void gemv_wrapper(bool trans, LAPACK_REAL alpha, LAPACK_REAL beta, LAPACK_INT m,
                  LAPACK_INT n, const LAPACK_REAL *A, const LAPACK_REAL *x,
                  LAPACK_INT incx, LAPACK_REAL *y, LAPACK_INT incy);

//
// zgemv - matrix*vector multiply
//
void gemv_wrapper(bool trans, Cplx alpha, Cplx beta, LAPACK_INT m, LAPACK_INT n,
                  Cplx const *A, Cplx const *x, LAPACK_INT incx, Cplx *y,
                  LAPACK_INT incy);

//
// dsyev
//
void dsyev_wrapper(char jobz,     // if jobz=='V', compute eigs and evecs
...
// dscal
//
void dscal_wrapper(LAPACK_INT N, LAPACK_REAL alpha, LAPACK_REAL *data,
                   LAPACK_INT inc = 1);
...
//
void dgeqrf_wrapper(LAPACK_INT *m,      // number of rows of A
                    LAPACK_INT *n,      // number of cols of A
                    LAPACK_REAL *A,     // matrix A
                                        // on return upper triangle contains R
                    LAPACK_INT *lda,    // size of A (usually same as n)
                    LAPACK_REAL *tau,   // scalar factors of elementary
                                        // reflectors length should be min(m,n)
                    LAPACK_INT *info);  // error info
...
//
void dorgqr_wrapper(
    LAPACK_INT *m,      // number of rows of A
    LAPACK_INT *n,      // number of cols of A
...
//
LAPACK_INT
dgesv_wrapper(LAPACK_INT n, LAPACK_INT nrhs, LAPACK_REAL *a, LAPACK_REAL *b);
...
//
LAPACK_INT
zgesv_wrapper(LAPACK_INT n, LAPACK_INT nrhs, Cplx *a, Cplx *b);
...
//
double dlange_wrapper(char norm, LAPACK_INT m, LAPACK_INT n, double *a);
...
//
LAPACK_REAL
zlange_wrapper(char norm, LAPACK_INT m, LAPACK_INT n, Cplx *a);
...
//
void dsygv_wrapper(char *jobz,      // if 'V', compute both eigs and evecs
