...
namespace itensor
{
    ...
    public:
        ...
        explicit Index(long dim,
                       TagSet const &ts = TagSet("0"));

        // Deprecated
        explicit Index(std::string s,
                       long m)
        {
        ...
        // Set tags
        Index &
        replaceTags(const TagSet &tsold, const TagSet &tsnew)
        {
