  ...
  SECTION("Truncating Degenerate Values")
  {
    ...
    SECTION("svd")
    {
      SECTION("MaxDim")
      {
        ...
        SECTION("No QNs, don't truncate degenerate")
        {
          auto [U, S, V] = svd(A, {i}, {"MaxDim=", cutoff_dim, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == cutoff_dim);
          auto v = commonIndex(S, V);
        ...
        SECTION("No QNs, truncate degenerate")
        {
          auto [U, S, V] = svd(A, {i}, {"RespectDegenerate=", true, "MaxDim=", cutoff_dim, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == nblck);
          auto v = commonIndex(S, V);
          CHECK(dim(v) == nblck);
        ...
        SECTION("QNs, don't truncate degenerate")
        {
          auto [U, S, V] = svd(Aqn, {i}, {"MaxDim=", cutoff_dim, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == cutoff_dim);
          auto v = commonIndex(S, V);
          CHECK(dim(v) == cutoff_dim);
        ...
        SECTION("QNs, truncate degenerate")
        {
          auto [U, S, V] = svd(Aqn, {i}, {"RespectDegenerate=", true, "MaxDim=", cutoff_dim, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == nblck);
          auto v = commonIndex(S, V);
          CHECK(dim(v) == nblck);
      ...
      SECTION("MinDim")
      {
        ...
        SECTION("No QNs, don't truncate degenerate")
        {
          auto [U, S, V] = svd(A, {i}, {"MinDim=", cutoff_dim, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == cutoff_dim);
          auto v = commonIndex(S, V);
          CHECK(dim(v) == cutoff_dim);
        ...
        SECTION("No QNs, truncate degenerate")
        {
          auto [U, S, V] = svd(A, {i}, {"RespectDegenerate=", true, "MinDim=", cutoff_dim, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == dim(i) - nblck);
          auto v = commonIndex(S, V);
        ...
        SECTION("QNs, don't truncate degenerate")
        {
          auto [U, S, V] = svd(Aqn, {i}, {"MinDim=", cutoff_dim, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == cutoff_dim);
          auto v = commonIndex(S, V);
          CHECK(dim(v) == cutoff_dim);
        ...
        SECTION("QNs, truncate degenerate")
        {
          auto [U, S, V] = svd(Aqn, {i}, {"RespectDegenerate=", true, "MinDim=", cutoff_dim, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == dim(i) - nblck);
          auto v = commonIndex(S, V);
          CHECK(dim(v) == dim(i) - nblck);
      ...
      SECTION("Cutoff")
      {
        ...
        SECTION("No QNs, truncate degenerate")
        {
          auto [U, S, V] = svd(A, {i}, {"RespectDegenerate=", true, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == dim(i) - nblck);
          auto v = commonIndex(S, V);
          CHECK(dim(v) == dim(i) - nblck);
        ...
        SECTION("QNs, truncate degenerate")
        {
          auto [U, S, V] = svd(Aqn, {i}, {"RespectDegenerate=", true, "Cutoff=", cutoff});
          auto u = commonIndex(U, S);
          CHECK(dim(u) == dim(i) - nblck);
          auto v = commonIndex(S, V);
          CHECK(dim(v) == dim(i) - nblck);
